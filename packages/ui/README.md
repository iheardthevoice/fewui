...
Vue 3 tasarım sistemi: **64 global bileşen** (`ui-button`, `ui-intro`, `ui-sidebar-item`, `ui-dialog`, …), OKLCH tema token’ları, runtime `applyUiTheme`, vue-i18n (`tr` / `en`).
...
ActionCard, ActionCardList, ActionGroup, AiButton, Alert, Avatar, Badge, Button, Card, Checkbox, CheckboxGroup, ColorPicker, ConfirmDialog, CurrencyInput, DatePicker, DateRangePicker, Dialog, Divider, Dropdown, Empty, Field, File, FormRow, Icon, IconPicker, Input, Intro, List, ListItem, Menu, MenuGroup, MenuItem, MenuNav, Password, Phone, Photo, Photos, Pin, Popover, Progress, Radio, RadioGroup, Segment, SegmentGroup, Select, SidebarItem, Skeleton, Slider, Stepper, Switch, Table (+ alt parçalar), Tabs, TabList, TabTrigger, TabPanel, Tag, TimePicker, Toast, Tooltip.
